        ...
        <form class="card card-md" action="{{route('register')}}" method="post" autocomplete="off" novalidate>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="ap" class="form-control @error('ap') is-invalid @enderror" placeholder="Ingrese su apellido paterno">
                    @error('ap')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="am" class="form-control @error('am') is-invalid @enderror" placeholder="Ingrese su apellido materno">
                    @error('am')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="telefono" class="form-control @error('telefono') is-invalid @enderror" placeholder="Ingrese su número de teléfono">
                    @error('telefono')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
